...
break;
  ...
  function checkGameEnd() {
    if (userScore === 3 || computerScore === 3) {
      if (userScore === 3) {
        userScore_span.innerHTML = userScore;
        result_div.innerHTML += `<p>Congratulations, ${userName}! Du har nått 3 poäng och vunnit spelet!</p>`;
      } else {
        computerScore_span.innerHTML = computerScore;
        result_div.innerHTML += `<p>Tyvärr, ${userName}! Datorn har nått 3 poäng och vunnit spelet.</p>`;
      }
      endGame();
